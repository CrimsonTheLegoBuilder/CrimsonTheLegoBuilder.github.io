...
\\(N = 2 or N = 4\\) 인 경우는 아래 그림과 같습니다. 세 직선을 각각 `l1, l2, l3` 라고 하겠습니다. `l1, l2` 의 각 이등분선 2게, `l1, l3` 의 각 이등분선 2개가 각각 만들어지고, 이 네 직선들의 교점은 4개 (`l2, l3` 가 평행한 경우 2개) 만들어집니다. 어떤 경우에도 답은 `Many` 가 됩니다.
...
모든 직선이 한 점에서 만나는 경우, 직선이 4개인데도 답이 여러개인 경우가 존재합니다.

![corner](/assets/images/2023-11-08-point/corner.jpg)
